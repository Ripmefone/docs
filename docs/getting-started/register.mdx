...
to register an account, you'll need to follow these simple steps to register an account:

:::info

This is step is *optional*, **you don't need to create an account** to try SKlauncher as you will read in the [Log in](/getting-started/login) guide.\
